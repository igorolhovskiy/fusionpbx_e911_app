...
*/
	...
	echo "</td>\n";
	echo "<td class='vtable' align='left'>\n";
	echo "	<input class='formfld' type='text' name='e911_address_1' maxlength='255' value=\"$e911_address_1\">\n";
	echo "<br />\n";
    ...
    echo "</td>\n";
    echo "<td class='vtable' align='left'>\n";
    echo "  <input class='formfld' type='text' name='e911_address_2' maxlength='255' value=\"$e911_address_2\">\n";
    echo "<br />\n";
	...
	echo "</td>\n";
	echo "<td class='vtable' align='left'>\n";
	echo "	<input class='formfld' type='text' name='e911_city' maxlength='255' value=\"$e911_city\">\n";
	echo "<br />\n";
    ...
    echo "</td>\n";
    echo "<td class='vtable' align='left'>\n";
    echo "  <input class='formfld' type='text' name='e911_state' maxlength='255' value=\"$e911_state\">\n";
    echo "<br />\n";
    ...
    echo "</td>\n";
    echo "<td class='vtable' align='left'>\n";
    echo "  <input class='formfld' type='text' name='e911_zip' maxlength='255' value=\"$e911_zip\">\n";
    echo "<br />\n";
    ...
    echo "</td>\n";
    echo "<td class='vtable' align='left'>\n";
    echo "  <input class='formfld' type='text' name='e911_zip_4' maxlength='255' value=\"$e911_zip_4\">\n";
    echo "<br />\n";
    ...
    echo "</td>\n";
    echo "<td class='vtable' align='left'>\n";
    echo "  <input class='formfld' type='text' name='e911_callername' maxlength='255' value=\"$e911_callername\">\n";
    echo "<br />\n";
    ...
    echo "</td>\n";
    echo "<td class='vtable' align='left'>\n";
    echo "  <input class='formfld' type='text' name='e911_alert_email' maxlength='255' value=\"$e911_alert_email\">\n";
    echo "<br />\n";
...
//    echo $sql_update;
	...
	if ($action == "update") {
		echo "		<input type='hidden' name='e911_uuid' value='$e911_uuid'>\n";
        echo "      <input type='hidden' name='e911_validated' value='$e911_validated'>\n";
	}
	echo "			<br>";
	echo "			<input type='submit' name='submit' class='btn' value='".$text['button-save']."'>\n";
	echo "		</td>\n";
